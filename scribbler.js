...
if (document.getElementsByClassName('demo').length > 0) {
    var i = 0;
    var txt = `profile -name "Chris Nelson"
    Degree from: Santa Clara University
    Class of: 2020
    Area of study: Computer Science & Engineering

    Experience
    - Software Dev I & II at Osisoft/Aveva (2.5 years)
    - Intern At Festo Robotics (1 year)

    Notable Technical Skills
    - Experience with production code, test driven development, and git
    - Extensive experience automating builds and testing in a cloud environment
    - Increased understanding of program design principles for large scale development
    - Knowledge of Swift/SwiftUI
    - Proficiency in automation and scripting with Python and Powershell
    - Have experience writing C# and C++ Test/Product code

    Personal Skills
    - Strong work ethic
    - Always seeking to learn and understand the 'why' in addition to the 'what'
    - Ability to communicate well in technical & non-technical contexts
